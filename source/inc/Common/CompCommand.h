...
enum class EKitBagType : char {
	player_or_boat = 0, // TODO: Separate into two types
	bank = 1,
	temporary = 2,
};
...
enum EEquipLinkPos // 道具的装备部位
{
	...
	//FIXED: Added new top2 item equip slots
	...
	enumEQUIP_NUM = 14,			// 装备部位的个数 //FIXED: 14 equip slots now available
...
enum class ELifeSkillType : char {
	manufacturing = 0,
	analyze = 1,
	crafting = 2,
	cooking = 3,
