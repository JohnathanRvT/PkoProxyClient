...
struct SItemGrid // 道具格内容
{
	...
	bool IsInstAttrValid() const { return sInstAttr[0][0] > 0 ? true : false; }
	...
	char GetForgeLv() { return chForgeLv; }
	...
	long GetForgeParam() const { return GetDBParam(enumITEMDBP_FORGE); }
