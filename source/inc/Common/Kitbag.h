...
public:
	...
	short GetUseGridNum(short sType = 0) const { return m_sUseNum[sType]; }
	...
	bool GetPosIDByGrid(SItemGrid* pGrid, short* psPosID = nullptr, short* psType = nullptr);
	...
	short GetVer() { return sVer; }

	CKitbag& operator=(CKitbag& bag);

protected:
	bool CheckValid() const; // for test
...
inline bool CKitbag::CheckValid() const {
	const short sUseNum = GetUseGridNum();
	short sFactNum = 0;
