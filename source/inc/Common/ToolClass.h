...
public:
	...
	long GetUsedNum() { return m_lUsed; }
	long GetSize() { return m_lSize; }

	T* Get(long lPosID);
	void BeginGet() { m_lSearchID = m_lUsed - 1; }
	T* GetNext();
...
public:
	...
	void BeginGet() { m_pSSearchPos = m_pSUsedQueue; }
	T* GetNext();
