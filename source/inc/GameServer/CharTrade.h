...
public:
	...
	// 放置或者取走物品到交易栏
	BOOL AddItem(BYTE byType, CCharacter& character, DWORD dwCharID, BYTE byOpType, BYTE byIndex, BYTE byItemIndex, WORD wCount);
...
public:
	...
	//水晶具体兑换
	BOOL RequestCrystalAdd(CCharacter* pCha, std::string act_tName, DWORD cha_tid, DWORD dwrplMoney, DWORD iCslPrice, DWORD iCslNum, DWORD dcslnum, int type, char quicktype, DWORD m_TAX);
	BOOL AcceptCrystalAdd(long long lOrderID, CrystalInfo* cryInfo);
	BOOL CancelCrystalAdd(long long lOrderID, CrystalInfo* cryInfo);

	BOOL RequestCrystalDel(CCharacter* pCha, std::string act_tName, DWORD cha_tid, DWORD dwrplMoney, DWORD iCslPrice, DWORD iCslNum, DWORD dcslnum, int type, char quicktype, DWORD m_TAX);
	BOOL AcceptCrystalDel(long long lOrderID, CrystalInfo* cryInfo);
	BOOL CancelCrystalDel(long long lOrderID, CrystalInfo* cryInfo);
	//定时更新状态
	BOOL RequestCrystalAdd(std::string act_Name, DWORD cha_id, std::string cha_name, DWORD dwrplMoney, DWORD iCslPrice, DWORD iCslNum, DWORD dcslnum, DWORD m_TAX);
	//返还水晶后操作
...
private:
	...
	BOOL PushOrder(DWORD cha_id, std::string cha_name, long long lOrderID, long lComID, long lNum); //Add by sunny.sun 20090519
