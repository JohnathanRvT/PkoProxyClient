...
public:
	...
	void BeginGetTNpc() { m_TalkNpcAlloc.revbegin(); }
	mission::CTalkNpc* GetNextTNpc() { return m_TalkNpcAlloc.revnext(); }

	void BeginGetItem() { m_ItemAlloc.revbegin(); }
	CItem* GetNextItem() { return m_ItemAlloc.revnext(); }

	void BeginGetCha() { m_ChaAlloc.revbegin(); }
	CCharacter* GetNextCha() { return m_ChaAlloc.revnext(); }

	long GetHoldChaNum() { return m_ChaAlloc.getHoldSize(); }
	long GetHoldItemNum() { return m_ItemAlloc.getHoldSize(); }
	long GetHoldTNpcNum() { return m_TalkNpcAlloc.getHoldSize(); }
	long GetMaxHoldChaNum() { return m_ChaAlloc.getMaxHoldSize(); }
	long GetMaxHoldItemNum() { return m_ItemAlloc.getMaxHoldSize(); }
	long GetMaxHoldTNpcNum() { return m_TalkNpcAlloc.getMaxHoldSize(); }

	long GetAllocChaNum() { return m_ChaAlloc.getAllocSize(); }
	long GetAllocItemNum() { return m_ItemAlloc.getAllocSize(); }
	long GetAllocTNpcNum() { return m_TalkNpcAlloc.getAllocSize(); }

private:
	using CHA_ALLOC = CAlloc<CCharacter>;
	CHA_ALLOC m_ChaAlloc;
	using ITEM_ALLOC = CAlloc<CItem>;
	ITEM_ALLOC m_ItemAlloc;
	using TALKNPC_ALLOC = CAlloc<mission::CTalkNpc>;
	TALKNPC_ALLOC m_TalkNpcAlloc;
	using BERTH_ALLOC = CAlloc<mission::CBerthEntity>;
	BERTH_ALLOC m_BerthAlloc;
	using RESOURCE_ALLOC = CAlloc<mission::CResourceEntity>;
...
public:
	...
	long GetHoldPlyNum() { return m_PlyAlloc.getHoldSize(); }
	long GetMaxHoldPlyNum() { return m_PlyAlloc.getMaxHoldSize(); }
	long GetAllocPlyNum() { return m_PlyAlloc.getAllocSize(); }

protected:
private:
	using PLAYER_ALLOC = CAlloc<CPlayer>;
