...
public:
	...
	dbc::uShort GetID() { return m_usID; }
	dbc::uShort GetTouchType() { return m_usTouchType; }
	dbc::uShort GetExecType() { return m_usExecType; }
	void* GetTableRec() { return m_pTableRec; }
	const dbc::Char* GetName() const { return m_szName; }
