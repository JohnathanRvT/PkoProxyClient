...
public:
	...
	virtual CEventEntity* IsEvent() override { return this; }
...
public:
	...
	virtual void SetType() override { m_byType = RESOURCE_ENTITY; }

	// 设置资源实体数据信息
	BOOL SetData(USHORT sItemID, USHORT sNum, USHORT sTime);

	// 传送实体消息处理
	virtual HRESULT MsgProc(CCharacter& character, dbc::RPacket& packet) override;

	// 获取实体状态信息
	virtual void GetState(CCharacter& character, BYTE& byState) override;
...
public:
	...
	virtual void Clear() override;
	virtual void SetType() override { m_byType = TRANSIT_ENTITY; }
...
public:
	...
	virtual void Clear() override;
	virtual void SetType() override { m_byType = BERTH_ENTITY; }
