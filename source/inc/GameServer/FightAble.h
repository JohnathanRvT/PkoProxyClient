...
public:
	...
	dbc::Short GetFightState() { return m_SFightProc.sState; }
	dbc::Short GetFightStopState() { return m_SFightInit.sStopState; }

	bool DesireFightBegin(SFightInit*);
	void DesireFightEnd() { EndFight(); }
	...
	void SynSkillStateToSelf();
	void SynSkillStateToEyeshot();
	...
	dbc::Long GetLevel() { return (long)m_CChaAttr.GetAttr(ATTR_LV); }
	void AddExp(LONG64);
...
protected:
	...
	CFightAble* IsFightAble() override { return this; }
...
private:
	...
	void OnFightBegin() { m_bOnFight = true; }
	void OnFightEnd() { m_bOnFight = false; }
