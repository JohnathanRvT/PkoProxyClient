...
public:
	...
	BOOL PointHitTest(int x, int y) override // 检查指定点是否在扇形范围
	{
		int nX = x - _x;
		int nY = _y - y;
	...
	BOOL RectHitTest(int x1, int y1, int x2, int y2) override {
...
public:
	...
	BOOL PointHitTest(int x, int y) override {
	...
	BOOL RectHitTest(int x1, int y1, int x2, int y2) override // , int x3, int y3, int x4, int y4)
	{
