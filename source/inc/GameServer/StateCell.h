...
public:
	CChaListNode(size_t ulSize = 1) : PreAllocStru(1) {
		m_pCCha = nullptr;
		m_pCNext = nullptr;
		m_pCLast = nullptr;
	}
...
public:
	CStateCell(size_t ulSize = 1) : PreAllocStru(1) {
		m_sPosX = 0;
		m_sPosY = 0;
		m_lActNum = 0;
		m_lChaNum = 0;
		m_pCChaIn = nullptr;
		m_pCChaCross = nullptr;

		m_pCNext = nullptr;
		m_pCLast = nullptr;
	}

	long GetChaNum() { return m_lChaNum; }

#ifdef COMPACT_MEM_2
	long GetStateNum(void) {
		return (long)m_CSkillState.m_SStateMap.size();
	}
#else
	long GetStateNum() {
		return m_CSkillState.m_uchStateNum;
	}
#endif
...
public:
	CStateCellNode(size_t ulSize = 1) : PreAllocStru(1) {
		m_pCStateCell = nullptr;
		m_pCChaNode = nullptr;
		m_pCNext = nullptr;
		m_pCLast = nullptr;
	}
