...
public:
	...
	lwIResourceMgr* _res_mgr{nullptr};
	lwINodeObject* _model_lxo{nullptr};
	lwIModel* _model_lmo{nullptr};
	lwIItem* _arrow{nullptr};
...
public:
	...
	void LoadingCall() override; // 在装载loading后,刷新
...
private:
	...
	static void _evtRoleInfoFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtLanchInfoFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtAimiInfoFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtFelierInfoFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtCaxiusInfoFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtRoleAllInfoFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
};
