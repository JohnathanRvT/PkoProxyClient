...
public:
	...
	virtual CStateSynchro* Gouge(float fRate) override;
	virtual CCharacter* GetHarmCha() override { return _pTarget; }
...
public:
	...
	virtual CCharacter* GetHarmCha() override { return _pAttack; }
...
public:
	...
	virtual CCharacter* GetHarmCha() override { return _pCha; }
