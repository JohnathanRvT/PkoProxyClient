...
// NPC交易
extern void CS_Sale(DWORD dwNpcID, BYTE byIndex, WORD wCount);
extern void CS_Buy(DWORD dwNpcID, BYTE byItemType, BYTE byIndex1, BYTE byIndex2, WORD wCount);

// 船舱货物交易
extern void CS_SelectBoatList(DWORD dwNpcID, BYTE byType, BYTE byIndex);
extern void CS_SaleGoods(DWORD dwNpcID, DWORD dwBoatID, BYTE byIndex, WORD wCount);
extern void CS_BuyGoods(DWORD dwNpcID, DWORD dwBoatID, BYTE byItemType, BYTE byIndex1, BYTE byIndex2, WORD wCount);
...
extern void CS_AddItem(BYTE byType, DWORD dwCharID, BYTE byOpType, BYTE byIndex, BYTE byItemIndex, WORD wCount);
...
extern void CS_StallBuy(DWORD dwCharID, BYTE byIndex, WORD wCount);
