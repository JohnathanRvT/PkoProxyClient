...
public:
	...
	virtual void BeginAction(CCharacter* pCha, DWORD type, const void* param, CActionState* pState) = 0;
	virtual void EndAction(CActionState* pState) = 0;
...
public:
	...
	virtual void BeginAction(CCharacter* pCha, DWORD type, const void* param, CActionState* pState) override;
	virtual void EndAction(CActionState* pState) override;
};
