...
public:
	...
	virtual const char* GetExplain() override { return "CWaitAttackState"; }

	virtual void ActionBegin(DWORD pose_id) override;
	virtual void ActionFrame(DWORD pose_id, int key_frame) override;
	virtual void ActionEnd(DWORD pose_id) override;
	virtual void FrameMove() override;
	virtual void MoveEnd(int x, int y, int nState) override;
	virtual void ServerEnd(int nState) override;
	virtual void SetServerID(int n) override;
...
public:
	...
	virtual const char* GetExplain() override { return "CAttackState"; }

	virtual void FrameMove() override;
	virtual void PushPoint(int x, int y) override;
	virtual void MoveEnd(int x, int y, int nState) override;
	virtual void ActionFrame(DWORD pose_id, int key_frame) override;
	virtual void ActionBegin(DWORD pose_id) override;
	virtual void ActionEnd(DWORD pose_id) override;
	virtual bool IsAllowUse() override;
...
protected:
	virtual void _UseSkill() override;
...
public:
	...
	virtual void MoveEnd(int x, int y, int nState) override;
	virtual void ServerEnd(int nState) override;
	virtual void BeforeNewState() override { _IsTrace = false; }
	virtual const char* GetExplain() override { return "CTraceAttackState"; }
...
public:
	...
	virtual const char* GetExplain() override { return "CHitAttackState"; }
...
public:
	...
	virtual const char* GetExplain() override { return "CAllPoseState"; }
