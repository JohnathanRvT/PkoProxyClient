...
public:
	...
	virtual const char* GetExplain() override { return "CWaitMoveState"; }
...
public:
	...
	virtual void FrameMove() override;
	virtual void Cancel() override;
	virtual const char* GetExplain() override { return "CMoveState"; }
...
public:
	...
	virtual const char* GetExplain() override { return "CServerMoveState"; }
...
public:
	...
	virtual void PushPoint(int x, int y) override;
	virtual void MoveEnd(int x, int y, int nState) override;
	virtual const char* GetExplain() override { return "COneMoveState"; }
