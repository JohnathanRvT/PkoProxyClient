...
private:
	BOOL _Create(int nObjTypeID, int nType) override;

public:
	CSceneObj();
	virtual ~CSceneObj() {}

	void FrameMove(DWORD dwTimeParam) override;
...
protected:
	void _UpdateYaw() override;
	void _UpdatePitch() override;
	void _UpdateRoll() override;
	void _UpdateHeight() override;
	void _UpdatePos() override;
	void _UpdateValid(BOOL bValid) override;
