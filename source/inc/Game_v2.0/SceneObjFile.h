...
constexpr auto OBJ_FILE_VER100{100};
constexpr auto OBJ_FILE_VER200{200};
constexpr auto OBJ_FILE_VER300{300};
constexpr auto OBJ_FILE_VER400{400};
constexpr auto OBJ_FILE_VER500{500};
constexpr auto OBJ_FILE_VER600{600};
constexpr auto MAX_MAP_SECTION_OBJ{25};
...
public:
	...
	long TrimFile(char* ptcsFileName, bool bBackUp);
