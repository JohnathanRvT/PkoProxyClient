...
public:
	static void __ButtonYesNo(CGuiData* pSender, int x, int y, MouseClickState dwKey);
	static void __ProcBtnItem(CGuiData* sender, int x, int y, MouseClickState key);
	static void __ProcBtnView3d(CGuiData* sender, int x, int y, MouseClickState key);
	...
	static void __ButtonOpenRoom(CGuiData* pSender, int x, int y, MouseClickState dwKey);
	static void __ButtonCloseRoom(CGuiData* pSender, int x, int y, MouseClickState dwKey);
...
public:
	...
	BOOL Update(const xShipBuildInfo* info, BOOL flag, const char* name);
	BOOL UpdateBoatCreate(const xShipBuildInfo* info, BOOL flag, const char* name);
	BOOL UpdateBoatInfo(const xShipBuildInfo* info, BOOL flag, const char* name);
	BOOL UpdateBoatFreedomTrade(const char* name, DWORD* dwModelInfo, size_t size);
	BOOL SetShipModelInfo(const DWORD* dwModelInfo, size_t size);
	BOOL CreateShip(DWORD type_id, const DWORD* part_buf); // tyep_id: 301
...
public:
	...
	static void __ButtonClose(CGuiData* pSender, int x, int y, MouseClickState dwKey);
