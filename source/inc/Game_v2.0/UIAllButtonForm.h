...
public:
	static void _evtAllButtonMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	virtual bool Init() override;
	static void evtCloseCompany(CGuiData* pSender);
	static void evtbtnClickDown(CGuiData* pSender, int x, int y, MouseClickState key);
	static void evtElfCoinFormClose(CForm* pForm, bool& IsClose);

	void ShowAllForm(bool bShow);
	void GetLeaveTime(int iTime);
	void CloseAllForm(bool bClose);
	static void CloseAllFormButThis(std::string FormName);
