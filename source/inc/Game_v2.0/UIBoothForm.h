...
private:
	...
	static void _InquireSetupPushItemNumEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _InquireSetupPushItemPriceEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _InquireSetupPopItemNumEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _InquireTradeItemNumEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);

	static void _BuyGoodsEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _BuyAGoodEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
...
private:
	static void _evtSelectBox(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtMsgBox(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
