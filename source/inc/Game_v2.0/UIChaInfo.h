...
private:
	...
	static void _evSFrm(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _evQFrm(CGuiData* pSender, int x, int y, MouseClickState key);
...
public:
	...
	using ResoultList = std::list<stQueryResoultPersonInfo>;
