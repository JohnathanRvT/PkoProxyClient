...
private:
	static void _evtbtnForgeYes(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtbtnForgeSend(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
