...
private:
	// 创建二次密码表单按钮事件
	static void _evtCreateFromMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);

	// 修改二次密码表单按钮事件
	static void _evtAlterFromMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);

	// 输入二次密码表单按钮事件
	static void _evtDoublePwdFromMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);

	// 二次密码输入软键盘表单按钮事件
	static void _evtInputFromMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
