...
private:
	static void _TreeMouseDown(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _TreeSelectLost(CGuiData* pSender);
	static void _ColorMouseDown(CGuiData* pSender, int x, int y, MouseClickState key);
