...
private:
	...
	static void _evtFindTeamMouseButton(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey); // 鼠标点击按钮事件
	static void _evtFindTeamCheckEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);  // 组队申请
};
