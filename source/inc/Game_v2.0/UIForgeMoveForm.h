...
public:
	CForgeMoveMgr() : frmforgeMove(nullptr) {}
...
private:
	...
	static void evtForgeMove(CGuiData* pSender, int x, int y, MouseClickState key);
	static void evtThrowDialogEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
