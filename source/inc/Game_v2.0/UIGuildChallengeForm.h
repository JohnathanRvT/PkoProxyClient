...
private:
	static void _FirstChallengeButtonDown(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _SecondChallengeButtonDown(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _ThirdChallengeButtonDown(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _enterChargeMoney(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _ChargeEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
