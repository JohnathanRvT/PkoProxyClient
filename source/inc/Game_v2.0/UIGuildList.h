...
public:
	...
	static void OnClickSortByGuildName(CGuiData* pSender, int x, int y, MouseClickState key);
	static void OnClickSortByGuildMemberCount(CGuiData* pSender, int x, int y, MouseClickState key);
	static void OnClickSortByGuildExperience(CGuiData* pSender, int x, int y, MouseClickState key);
	static void OnSelectChange(CGuiData* pSender);
	static void OnClickApply(CGuiData* pSender, int x, int y, MouseClickState key);
	static void OnMsgReplaceApply(std::string strOldGuildName);
	static void OnMsgReplaceApplySelectClick(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
