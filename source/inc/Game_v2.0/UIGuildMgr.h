...
private:
	...
	static void _OnClickEditMottoName(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _OnClickDismiss(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _OnClickRecruit(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _OnClickRefuse(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _OnClickKick(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _OnClickSelectPage(CGuiData* pSender);
	static void _OnClickLeave(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _OnPassKick(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _OnPassDismiss(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);

	static CForm* m_pGuildMottoNameEditForm;
	static CEdit* m_pedtGuildMottoName;
	static CTextButton* m_pbtnGuildMottoFormOK;
	static void _OnClickMottoFormOK(CGuiData* pSender, int x, int y, MouseClickState key);
	...
	static void SendInviteName(CGuiData *pSender, int x, int y, MouseClickState key);
	//	End.
