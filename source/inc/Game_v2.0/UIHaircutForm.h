...
private:
	...
	static void _gui_event_left_color(CGuiData* sender, int x, int y, MouseClickState key);
	static void _gui_event_right_color(CGuiData* sender, int x, int y, MouseClickState key);
	static void _gui_event_left_hair(CGuiData* sender, int x, int y, MouseClickState key);
	static void _gui_event_right_hair(CGuiData* sender, int x, int y, MouseClickState key);
	static void _gui_event_left_rotate(CGuiData* sender, int x, int y, MouseClickState key);
	static void _gui_event_right_rotate(CGuiData* sender, int x, int y, MouseClickState key);
