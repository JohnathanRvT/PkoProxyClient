...
private:
	...
	static void evtJewelryUpCommit(CGuiData* pSender, int x, int y, MouseClickState key);
	static void evtConfirmEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
