...
protected:
	using vitems = std::deque<CItemRow*>;
	vitems _items;
...
public:
	...
	virtual bool Clone(CListItems* rhs) override;
	virtual void Clear() override;
	virtual void SetRect(int x1, int y1, int x2, int y2, int rowheight) override;
	virtual void Render() override;

public:
	virtual CItemRow* Add(const char* str, DWORD c) override;
	virtual bool SetColumnWidth(unsigned int nCol, unsigned int width) override;
	virtual unsigned int GetColumn() override { return _nCol; }

private:
	virtual int _GetColumnWidth(unsigned int nCol) override;
