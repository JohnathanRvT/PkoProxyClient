...
private: /*Call back Functions*/
	static void _MainMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	...
	static void _evtConfirmEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtConfirmCancelEvent(CForm* pForm);
	static void _evtFusionNoCatalyzerConfirmEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
...
private:
	static constexpr int STONE_ITEM_NUM = 2; //宝石合成数量
	static constexpr int ITEM_NUM = 4;		 //其他合成数量
	static constexpr int FUSION_NUM = 3;	 //熔合Item数量
	static constexpr int UPGRADE_NUM = 2;	//升级Item数量
	static constexpr int SHIFT_NUM = 2;		 //精灵二转Item数量

	static constexpr int GEM_ROULEAU_TYPE = 47;   //宝石卷轴道具类型号
	static constexpr int GEN_STONE_TYPE = 49;
	static constexpr int FORGE_STONE_TYPE = 50;
	static constexpr int EQUIP_FUSION_CATALYZER_TYPE = 61;
	static constexpr int APPEAR_EQUIP_BASE_ID = 5000;
	static constexpr int EQUIP_UPGRADE_ROULEAU_TYPE = 62;
	static constexpr int EQUIP_UPGRADE_SPAR = 63;
	static constexpr int FORGE_SUCCESS_EFF_ID = 345;
	static constexpr int FORGE_FAILED_EFF_ID = 346;

	static constexpr long MAKE_EQUIP_MONEY = 5000;
	static constexpr long EQUIP_FUSION_MONEY = 1000; // 熔合乘以的钱数
	static constexpr long EQUIP_UPGRADE_MONEY = 10000;
	...
	using EquipList = std::vector<EquipInfo*>;
	using EquipListIter = EquipList::iterator;
