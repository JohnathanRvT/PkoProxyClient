...
public:
	...
	void SaleToNpc(BYTE byIndex, WORD wCount, USHORT sItemID, DWORD dwMoney);
	void BuyFromNpc(BYTE byIndex, WORD wCount, USHORT sItemID, DWORD dwMoney);
...
protected:
	...
	static void _BuyTradeEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _SaleTradeEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);

	// 卖买单个装备时要确认
	static void _BuyEquipYesNoTradeEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _SaleEquipYesNoTradeEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
