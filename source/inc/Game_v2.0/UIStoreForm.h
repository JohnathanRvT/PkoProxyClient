...
private:
	...
	static void _evtDragItemsEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
...
private:
	...
	static constexpr int STORE_PAGE_SIZE = 9; // 商品列表一页最多 9 条
	...
	using MapNode = std::map<long, std::string>;
	using MapNodeIter = std::map<long, std::string>::iterator;
	...
	bool _IsCurSelVipNode();

	static void _evtStoreTreeMouseClick(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _evtStoreOpenCheckEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtStoreToVipEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtExchangeEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtExchangeCheckEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtTradeCheckEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtStoreFormClose(CForm* pForm, bool& IsClose);

	static void _evtStoreFormMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
	static void _evtStoreListMouseRClick(CGuiData* pSender, int x, int y, MouseClickState key);
	static void _evtStoreListMouseDBClick(CGuiData* pSender, int x, int y, MouseClickState key);
...
private:
	...
	static void _evtStoreViewAllMouseEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey);
...
private:
	...
	static void _evtChaEquipClearAll(CGuiData* sender, int x, int y, MouseClickState key);
	static void _evtChaLeftRotate(CGuiData* sender, int x, int y, MouseClickState key);
	static void _evtChaRightRotate(CGuiData* sender, int x, int y, MouseClickState key);
