...
{
	stNetActorCreate() : ulWorldID(0), lHandle(0), ulChaID(0), chCtrlType(0), sAngle(0), ulTLeaderID(0), sState(0), sIcon(0), chSeeType(enumENTITY_SEEN_NEW), szCommName(NULL), strGuildName(""), strMottoName(""), strGuildMotto(""),
