...
public:
	...
	*/
	...
	std::atomic<long> m_taskexitflag;
...
public:
	...
	* @brif 构造函数
	*/
	Task() : __canwait(false), __ThisThread(nullptr), __TaskQue(nullptr), __nexttask(nullptr), __taskwait(nullptr) {
...
public:
	...
	*/
	PreAllocTask(size_t size) : PreAllocStru(size){};
