...
public:
	...
	const LERadian& operator=(const float& f) {
		m_fRad = f;
		return *this;
	}
	const LERadian& operator=(const LERadian& r) {
		m_fRad = r.m_fRad;
		return *this;
	}
	...
	LERadian& operator+=(const LERadian& r) {
		m_fRad += r.m_fRad;
		return *this;
	}
...
public:
	...
	const LEDegree& operator=(const float& f) {
		m_fDeg = f;
		return *this;
	}
	const LEDegree& operator=(const LEDegree& d) {
		m_fDeg = d.m_fDeg;
		return *this;
	}
	const LEDegree& operator=(const LERadian& r) {
	...
	LEDegree& operator+=(const LEDegree& d) {
		m_fDeg += d.m_fDeg;
		return *this;
	}
	LEDegree& operator+=(const LERadian& r) {
		m_fDeg += r.valueDegrees();
		return *this;
	}
