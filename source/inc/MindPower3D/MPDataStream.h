...
using MPDataStreamPtr = MPSharedPtr<MPDataStream>;
using MPDataStreamList = std::list<MPDataStreamPtr>;
using MPDataStreamListPtr = MPSharedPtr<MPDataStreamList>;
...
public:
	...
	*/
	...
	/** 得到这个流内存块的起始指针. */
	uchar* getPtr() { return m_Data; }

	/** 得到这个流目前指向的指针. */
	uchar* getCurrentPtr() { return m_Pos; }
...
using MPMemoryDataStreamPtr = MPSharedPtr<MPMemoryDataStream>;
