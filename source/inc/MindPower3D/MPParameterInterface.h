...
using MPParameterList = std::vector<MPParameterDef>;
...
using ParamCommandMap = std::map<String, MPParamCommand*>;
...
public:
	...
	*/
	...
	const MPParameterList& getParameters() const {
		return m_ParamDefs;
	}
};

using MPParamDictionaryMap = std::map<String, MPParamDictionary>;
