...
class CD3DFont {
	...
	LPDIRECT3DDEVICEX m_pd3dDevice; // A D3DDevice used for rendering
	LPDIRECT3DTEXTUREX m_pTexture;  // The d3d texture for this font
...
public:
	...
	HRESULT InitDeviceObjects(LPDIRECT3DDEVICEX pd3dDevice);
