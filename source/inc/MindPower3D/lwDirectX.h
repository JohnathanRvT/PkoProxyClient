...
#define D3DXAssembleShaderX(pSrcData, SrcDataLen, pDefines, pInclude, Flags, ppShader, ppErrorMsgs) \
	D3DXAssembleShader(pSrcData, SrcDataLen, pDefines, pInclude, Flags, ppShader, ppErrorMsgs)
...
#define D3DXAssembleShaderX(pSrcData, SrcDataLen, pDefines, pInclude, Flags, ppShader, ppErrorMsgs) \
	D3DXAssembleShader(pSrcData, SrcDataLen, Flags, nullptr, ppShader, ppErrorMsgs)
