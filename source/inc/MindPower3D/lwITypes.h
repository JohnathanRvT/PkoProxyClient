...
using lwPoseKeyFrameProc = void (*)(DWORD type, DWORD pose_id, DWORD key_id, DWORD key_frame, void* param);
...
class lwITreeNode;
using lwTreeNodeEnumProc = DWORD (*)(lwITreeNode* node, void* param);
