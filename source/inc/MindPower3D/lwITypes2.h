...
struct lwMeshInfo {
	...
	lwMeshInfo()
		: vertex_seq(nullptr), normal_seq(nullptr), vercol_seq(nullptr), index_seq(nullptr),
		  subset_seq(nullptr), blend_seq(nullptr), bone_index_seq(nullptr),
		  ...
		  bone_infl_factor(0), vertex_element_seq(nullptr), vertex_element_num(0) {
