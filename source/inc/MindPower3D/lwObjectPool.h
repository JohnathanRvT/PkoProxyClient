...
using lwObjectPoolVoidPtr1024 = lwObjectPool<void*, 1024>;
using lwObjectPoolVoidPtr2048 = lwObjectPool<void*, 2048>;
using lwObjectPoolVoidPtr4096 = lwObjectPool<void*, 4096>;
using lwObjectPoolVoidPtr10240 = lwObjectPool<void*, 10240>;
using lwObjectPoolVoidPtr40960 = lwObjectPool<void*, 40960>;
using lwObjectPoolVoidPtr102400 = lwObjectPool<void*, 102400>;
using lwObjectPoolDword10240 = lwObjectPool<DWORD, 10240>;
using lwObjectPoolDword40960 = lwObjectPool<DWORD, 40960>;
