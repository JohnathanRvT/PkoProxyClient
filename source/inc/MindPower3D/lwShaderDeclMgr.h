...
public:
	...
	LW_RESULT CreateShaderDeclSet(DWORD decl_type, DWORD buf_size) override;
	LW_RESULT SetShaderDeclInfo(lwShaderDeclCreateInfo* info) override;
	LW_RESULT QueryShaderHandle(DWORD* shader_handle, const lwShaderDeclQueryInfo* info) override;
};
