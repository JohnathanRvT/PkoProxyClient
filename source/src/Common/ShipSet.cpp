...
BOOL xShipSet::_ReadRawDataInfo(CRawDataInfo* pRawDataInfo, std::vector<std::string>& ParamList) {
	if (ParamList.empty())
		return FALSE;
	...
	//pInfo->szName[BOAT_MAXSIZE_NAME - 1] = '\0';
	...
	//pInfo->szDesp[BOAT_MAXSIZE_DESP - 1] = '\0';
...
BOOL xShipPartSet::_ReadRawDataInfo(CRawDataInfo* pRawDataInfo, std::vector<std::string>& ParamList) {
	if (ParamList.empty())
		return FALSE;
