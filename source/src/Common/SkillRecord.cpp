...
BOOL CSkillRecordSet::_ReadRawDataInfo(CRawDataInfo* pRawDataInfo, std::vector<std::string>& ParamList) {
	if (ParamList.empty())
		return FALSE;
	...
	//pInfo->szName[defSKILL_NAME_LEN - 1] = '\0';

	int m = 0, n = 0;
	std::string strList[80], strSub[10];
	std::string strLine;
	...
	//pInfo->szPrepare[defSKILL_RANGE_SET_SCRIPT - 1] = '\0';
	...
	//pInfo->szRangeState[defSKILL_EFFECT_SCRIPT_LEN - 1] = '\0';
	...
	//pInfo->szUseSP[defSKILL_EFFECT_SCRIPT_LEN - 1] = '\0';
	...
	//pInfo->szUseEndure[defSKILL_EFFECT_SCRIPT_LEN - 1] = '\0';
	...
	//pInfo->szUseEnergy[defSKILL_EFFECT_SCRIPT_LEN - 1] = '\0';
	...
	//pInfo->szSetRange[defSKILL_EFFECT_SCRIPT_LEN - 1] = '\0';
	...
	//pInfo->szUse[defSKILL_RANGE_SET_SCRIPT - 1] = '\0';
	...
	//pInfo->szEffect[defSKILL_RANGE_SET_SCRIPT - 1] = '\0';
	...
	//pInfo->szActive[defSKILL_RANGE_SET_SCRIPT - 1] = '\0';
	...
	//pInfo->szInactive[defSKILL_RANGE_SET_SCRIPT - 1] = '\0';
	...
	//pInfo->szFireSpeed[defSKILL_EFFECT_SCRIPT_LEN - 1] = '\0';
	...
	//pInfo->szICON[defSKILL_ICON_NAME_LEN - 1] = '\0';
