...
// 单件CTAMgr
class CTAMgr {
	friend class std::unique_ptr<CTAMgr>;
	friend std::unique_ptr<CTAMgr>::deleter_type;
...
CTAMgr* CTAMgr::_instance = nullptr;
...
public:
	...
	bool load() override;
	bool chfile(char const* fname, char const* mode = "rb") override;
...
public:
	...
	bool get_attr(unsigned int x, unsigned int y, unsigned short& attrib) override;
	bool has_attr(unsigned int x, unsigned int y, ::byte attrib_mask) override;
	bool get_island(unsigned int x, unsigned int y, ::byte& island) override;
	bool get_info(unsigned int& width, unsigned int& height) override;
};
...
class tamem_mgr {
	...
	friend class std::unique_ptr<tamem_mgr>;
	friend std::unique_ptr<tamem_mgr>::deleter_type;
...
using TAM_MGR = cfl_singleton_ap<tamem_mgr>;
