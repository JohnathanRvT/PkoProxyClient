...
std::vector<CGuildInviteFormMgr::PS_FormNode> CGuildInviteFormMgr::m_FormLink;
...
bool CGuildInviteFormMgr::AddInviteForm(DWORD id,std::string inviterName)
{
...
void CGuildInviteFormMgr::_MainMousePlayerGuildEvent(CCompent* pSender, int nMsgType, int x, int y, MouseClickState dwKey) {
