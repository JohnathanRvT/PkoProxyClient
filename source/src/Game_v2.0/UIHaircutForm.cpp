...
bool CHaircutMgr::Init() {
	...
	for (int i(0); i < defHAIR_MAX_ITEM; i++) {
		_snprintf_s(szBuf, _TRUNCATE, "cmdHead%d", i + 1);
...
void CHaircutMgr::Refresh(DWORD dwHairType, DWORD dwHairColor) {
	...
	_snprintf_s(szBuf, _TRUNCATE, "%d", pHairRecord->dwMoney);
	...
	for (int j(0); j < pGrid->GetMaxNum(); j++) {
		auto* pItem = dynamic_cast<CItemCommand*>(pGrid->GetItem(j));
		if (!pItem)
			continue;
...
//~ ==================================================================
void CHaircutMgr::_gui_event_left_color(CGuiData* sender, int x, int y, MouseClickState key) {
	g_stUIHaircut.ChangeHairColor(LEFT);
}

//~ ==================================================================
void CHaircutMgr::_gui_event_right_color(CGuiData* sender, int x, int y, MouseClickState key) {
	g_stUIHaircut.ChangeHairColor(RIGHT);
}

//~ ==================================================================
void CHaircutMgr::_gui_event_left_hair(CGuiData* sender, int x, int y, MouseClickState key) {
	g_stUIHaircut.ChangeHairType(LEFT);
}

//~ ==================================================================
void CHaircutMgr::_gui_event_right_hair(CGuiData* sender, int x, int y, MouseClickState key) {
	g_stUIHaircut.ChangeHairType(RIGHT);
}

//~ ==================================================================
void CHaircutMgr::_gui_event_left_rotate(CGuiData* sender, int x, int y, MouseClickState key) {
	g_stUIHaircut.RotateCha(LEFT);
}

//~ ==================================================================
void CHaircutMgr::_gui_event_right_rotate(CGuiData* sender, int x, int y, MouseClickState key) {
