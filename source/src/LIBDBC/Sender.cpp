...
public:
	SendAll(size_t size) : PreAllocTask(size) {}
...
Sender::Sender(DataSocket* datasock)
	: m_datasock(datasock), __tca(nullptr), m_p(0), m_send(nullptr), m_head(nullptr), m_tail(nullptr) {
...
void Sender::Init() {
	...
	m_semSndC.Create(__tca->__maxsndque, __tca->__maxsndque, nullptr);
}
//================================================================================
void SNDPacket::Init(DataSocket* datasock, size_t size) {
