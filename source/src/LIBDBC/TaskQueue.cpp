...
HANDLE Task::GetHandle() {
	return __ThisThread ? __ThisThread->GetHandle() : nullptr;
}
//==============================================================================
