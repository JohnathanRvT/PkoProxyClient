...
DR_RESULT drTex::Release() {
	...
	if (_reg_id == DR_INVALID_INDEX) {
		...
		((drResourceMgr*)_res_mgr)->_texlog_mgr.Log(0, _file_name, _data_info.width, _data_info.height, (D3DFORMAT)_format, _data_info.size);
#endif
		Unload();
		DR_DELETE(this);
	}
...
#if (defined USE_TEXLOG_MGR)
		((drResourceMgr*)_res_mgr)->_texlog_mgr.Log(1, "User tex", _data_info.width, _data_info.height, (D3DFORMAT)_format, _data_info.size);
#endif
...
#if (defined USE_TEXLOG_MGR)
		((drResourceMgr*)_res_mgr)->_texlog_mgr.Log(1, info->file_name, _data_info.width, _data_info.height, (D3DFORMAT)_format, _data_info.size);
#endif
...
#if (defined USE_TEXLOG_MGR)
	((drResourceMgr*)_res_mgr)->_texlog_mgr.Log(1, _file_name, _data_info.width, _data_info.height, (D3DFORMAT)_format, _data_info.size);
#endif
