...
void FormatDollorString(char* szBuf, size_t dwBufSize, size_t dwDollor) {
	if (dwDollor > 1000000) {
		sprintf_s(szBuf, dwBufSize, TEXT("%3zu,%03zu,%03zu"), dwDollor / 1000000, (dwDollor / 1000) % 1000, dwDollor % 1000);
	} else if (dwDollor > 1000) {
		sprintf_s(szBuf, dwBufSize, TEXT("%3zu,%03zu"), dwDollor / 1000, dwDollor % 1000);
	} else {
		sprintf_s(szBuf, dwBufSize, TEXT("%3zu"), dwDollor);
	}
}