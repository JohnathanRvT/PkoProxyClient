...
float* MPEffectMath::m_SinTable = nullptr;
float* MPEffectMath::m_TanTable = nullptr;
...
//-----------------------------------------------------------------------------
void MPEffectMath::buildTrigTables() {
	// ¹¹½¨²éÕÒ±í
	float angle;
...
//-----------------------------------------------------------------------------
MPEffectMath::AngleUnit MPEffectMath::getAngleUnit() {
	return m_sAngleUnit;
}
//-----------------------------------------------------------------------------
