...
lwHelperDummy::lwHelperDummy()
	: _obj_seq(nullptr), _obj_num(0), _obj(nullptr) {
}
...
LW_RESULT lwHelperDummy::Render() {
	if (_obj == nullptr || _visible_flag == 0)
		return LW_RET_OK;
...
lwBoundingBox::lwBoundingBox()
	: _obj_seq(nullptr), _obj_num(0), _data(0), _obj(nullptr) {
}
...
lwBoundingSphere::lwBoundingSphere()
	: _obj_seq(nullptr), _obj_num(0), _obj(nullptr), _data(0) {
}
...
lwHelperObject::lwHelperObject(lwIResourceMgr* mgr)
	: _res_mgr(mgr), _obj_dummy(nullptr), _obj_box(nullptr), _obj_mesh(nullptr), _obj_boundingbox(nullptr), _obj_boundingsphere(nullptr) {
}
