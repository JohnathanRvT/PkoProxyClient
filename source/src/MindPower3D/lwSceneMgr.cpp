...
lwSceneMgr::lwSceneMgr(lwISysGraphics* sys_graphics)
	: _sys_graphics(sys_graphics), _vf(nullptr), _sort_obj_seq(nullptr), _sort_obj_seq_size(0), _sort_obj_num(0), _max_sort_num(0) {
