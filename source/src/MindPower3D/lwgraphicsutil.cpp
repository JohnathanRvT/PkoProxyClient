...
LW_FRONT_API LW_RESULT lwLoadTexture(IDirect3DTextureX** tex, IDirect3DDeviceX* dev, const char* file, DWORD usage, D3DFORMAT fmt, D3DPOOL pool) {
	...
	if (LW_FAILED(lwLoadTexDataInfo(&info, file, fmt, COLORKEY_TYPE_NONE, nullptr, 0)))
		goto __ret;
	...
	if (FAILED(surface->LockRect(&lock_rc, nullptr, 0)))
		goto __ret;
...
LW_RESULT lwExtractMeshData(lwMeshInfo* info, void* vb_data, void* ib_data, DWORD vert_num, DWORD index_num, D3DFORMAT vb_fvf, D3DFORMAT ib_fvf) {
	...
	if (vert_num > 0) {
		...
		case FVF_XYZRHWDIFFUSETEX1: {
			using _FVF_STRUCT = lwFVFStruct_XyzwDiffuseTex1;
		...
		case FVF_XYZRHWDIFFUSETEX2: {
			using _FVF_STRUCT = lwFVFStruct_XyzwDiffuseTex2;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZDIFFUSE: {
			using _FVF_STRUCT = lwFVFStruct_XyzDiffuse;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZNORMALTEX1: {
			using _FVF_STRUCT = lwFVFStruct_XyzNormalTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZDIFFUSETEX1: {
			using _FVF_STRUCT = lwFVFStruct_XyzDiffuseTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZDIFFUSETEX2: {
			using _FVF_STRUCT = lwFVFStruct_XyzDiffuseTex2;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZNORMALDIFFUSETEX1: {
			using _FVF_STRUCT = lwFVFStruct_XyzNormalDiffuseTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZUBYTE4NORMALTEX1: {
			using _FVF_STRUCT = lwFVFStruct_XyzUbyte4NormalTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZB1DIFFUSETEX1: {
			using _FVF_STRUCT = lwFVFStruct_Xyzb1DiffuseTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZB1DIFFUSETEX2: {
			using _FVF_STRUCT = lwFVFStruct_Xyzb1DiffuseTex2;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZB2UBYTE4NORMALTEX1: {
			using _FVF_STRUCT = lwFVFStruct_Xyzb2Ubyte4NormalTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZB3UBYTE4NORMALTEX1: {
			using _FVF_STRUCT = lwFVFStruct_Xyzb3Ubyte4NormalTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
		...
		case FVF_XYZB4UBYTE4NORMALTEX1: {
			using _FVF_STRUCT = lwFVFStruct_Xyzb4Ubyte4NormalTex1;
			_FVF_STRUCT* buf = (_FVF_STRUCT*)vb_data;
			_FVF_STRUCT* p;
...
LW_RESULT _ConvertMeshDataVB(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	...
	default:
		...
		MessageBox(nullptr, "_ConvertMeshDataVB Unknown FVF format", "error", MB_OK);
		return LW_RET_FAILED;
	}
...
void _ConvertMeshData_xn(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	using _FVF_STRUCT = lwFVFStruct_XyzNormal;
...
void _ConvertMeshData_xndt2(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	using _FVF_STRUCT = lwFVFStruct_XyzNormalDiffuseTex2;
...
void _ConvertMeshData_xunt2(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	using _FVF_STRUCT = lwFVFStruct_XyzUbyte4NormalTex2;
	_FVF_STRUCT* buf = LW_NEW(_FVF_STRUCT[info->vertex_num]);
	_FVF_STRUCT* p;
...
void _ConvertMeshData_xb2unt2(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	using _FVF_STRUCT = lwFVFStruct_Xyzb2Ubyte4NormalTex2;
	_FVF_STRUCT* buf = LW_NEW(_FVF_STRUCT[info->vertex_num]);
	_FVF_STRUCT* p;
...
void _ConvertMeshData_xb3unt2(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	using _FVF_STRUCT = lwFVFStruct_Xyzb3Ubyte4NormalTex2;
	_FVF_STRUCT* buf = LW_NEW(_FVF_STRUCT[info->vertex_num]);
	_FVF_STRUCT* p;
...
void _ConvertMeshData_xb4unt2(void** data, DWORD* size, DWORD* stride, const lwMeshInfo* info) {
	using _FVF_STRUCT = lwFVFStruct_Xyzb4Ubyte4NormalTex2;
	_FVF_STRUCT* buf = LW_NEW(_FVF_STRUCT[info->vertex_num]);
	_FVF_STRUCT* p;
...
void lwScreenToWorld(lwVector3* org, lwVector3* ray, int x, int y, int width, int height, const lwMatrix44* mat_proj, const lwMatrix44* mat_view) {
	...
	lwMatrix44Inverse(&mat_inv, nullptr, mat_view);
