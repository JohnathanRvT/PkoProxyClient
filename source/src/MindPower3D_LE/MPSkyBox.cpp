...
const int CMPSkyBox::NUMFACES = 6;
...
HRESULT CMPSkyBox::RestoreDeviceObjects(LPDIRECT3DDEVICE8 pDev,
...
void CMPSkyBox::InvalidateDeviceObjects() {
	for (int q = 0; q < NUMFACES; q++) {
		SAFE_RELEASE(m_Texture[q]);
	}
}

void CMPSkyBox::DeleteDeviceObjects() {
}

void CMPSkyBox::Render(D3DXMATRIX& matView) {
	float f;
